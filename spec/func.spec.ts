...
describe("Web hook", () => {
	...
	describe("installation", () => {
		...
		it("installation.created adds all labels", async () => {
			const context = NewContext(MockNotifications.installation.created)
	...
	describe("check_suite", () => {
		it("check_suite.completed completes PR with approvals and passing checks", async () => {
			...
			nock("https://api.github.com")
				.get("/repos/AArnott/pr-autocomplete-scratch/pulls/2")
				.reply(200, MockReplies.get.pr.open_automerge_clean)
			nock("https://api.github.com")
